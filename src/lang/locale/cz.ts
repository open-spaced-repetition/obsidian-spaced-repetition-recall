...
export default {
    ...
    FLASHCARD_TAGS_DESC: 'Zadete tagy oodělené mezerou nebo odřádkováním například. #kartičky #balíčke2 #balíček3.',
    ...
    INLINE_SCHEDULING_COMMENTS: 'Uložit plánovací komentář na stejný řádek jako poslední položka kartičky?',
    INLINE_SCHEDULING_COMMENTS_DESC: 'Zapnutí této volby způsobí, že HTML komentáře nebudou rozbíjet formátování listů.',
    BURY_SIBLINGS_TILL_NEXT_DAY: 'Odložit příbuzné kartičky na další den?',
    BURY_SIBLINGS_TILL_NEXT_DAY_DESC: 'Příbuzné kartičky jsou kartičky generované z textu stejné poznámky například cloze smazání',
    ...
    CARD_MODAL_SIZE_PERCENT_DESC: 'Mělo by být nastaveno na 100% na mobilu nebo když používáte velké obrázky',
    ...
    CLOZE_PATTERNS_DESC: 'Zadejte cloze vzory oddělené odřádkováním. Check the <a href="${docsUrl}">wiki</a> for guidance.',
    INLINE_CARDS_SEPARATOR: 'Oddělovač pro inline kartičky',
    FIX_SEPARATORS_MANUALLY_WARNING: 'Pozor. Jakmile toto změníte, budete muset ručně upravit všechny existující kartičky.',
    ...
    ENABLE_FILE_MENU_REVIEW_OPTIONS: 'Povolte možnosti revize v nabídce souboru (např. Revize: Jednoduché, Dobré, Těžké)',
    ENABLE_FILE_MENU_REVIEW_OPTIONS_DESC: 'Pokud v nabídce souboru zakážete možnosti revize, můžete své poznámky revidovat pomocí příkazů pluginu a, pokud jste je definovali, pomocí přiřazených klávesových zkratek.',
    INITIALLY_EXPAND_SUBDECKS_IN_TREE: 'Stromy balíčky by měly být zpočátku zobrazeny jako rozbalené',
    INITIALLY_EXPAND_SUBDECKS_IN_TREE_DESC: 'Vypněte toto, chcete-li sbalit vnořené balíčky na stejné kartě. To je užitečné, pokud máte kartičky, které patří k mnoha balíčkům ve stejném souboru.',
    ...
    EASY_BONUS_DESC: 'Tento bonus umožňuje nastavit rozdíl intervalu mezi jednoduchými a dobrými kartičkami/poznámkami (minimum = 100%).',
    ...
    MAX_LINK_CONTRIB_DESC: 'Maximální příspěvek vážené složitosti prolinkovaných poznámek použitý pro určení počáteční složitosti.',
    FUZZING: 'Fuzzing',
