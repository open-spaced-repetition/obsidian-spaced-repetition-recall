...
export default {
    ...
    FIX_SEPARATORS_MANUALLY_WARNING: 'Si avvisa che dopo aver cambiato questo dovrai manualmente modificare le schede che hai già.',
    ...
    INITIALLY_EXPAND_SUBDECKS_IN_TREE_DESC: 'Disabilitami per collassare mazzi annidati nella stessa scheda. Utile se hai schede che appartengono a più mazzi nello stesso file.',
    ALGORITHM: 'Algoritmo',
    ...
    EASY_BONUS_DESC: 'Il bonus facilità ti permette di impostare le differenze negli intervalli tra il rispondere Buono e Facile su una scheda o nota (minimo 100%).',
    ...
    MAX_LINK_CONTRIB_DESC: 'Contributo massimo della difficoltà pasata delle note collegate alla difficoltà iniziale.',
    FUZZING: 'Fuzzing',
