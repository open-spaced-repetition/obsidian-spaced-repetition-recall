...
export default {
    ...
    GITHUB_DISCUSSIONS: 'Soru-cevap, geri bildirim ve genel tartışmalar için <a href="${discussionsUrl}">tartışmalar</a> bölümüne göz atın.',
    GITHUB_ISSUES: 'Bir özellik isteğiniz ya da hata bildiriminiz varsa <a href="${issuesUrl}">buradan</a> bildirin.',
    ...
    GITHUB_SOURCE_CODE: 'Proje kaynak koduna <a href="${githubProjectUrl}">GitHub</a> üzerinden ulaşabilirsiniz.',
    CODE_CONTRIBUTION_INFO: '<a href="${codeContributionUrl}">Kod katkıları</a> hakkında bilgi alın.',
    TRANSLATION_CONTRIBUTION_INFO: 'Eklentiyi kendi dilinize çevirmek hakkında bilgi için <a href="${translationContributionUrl}">çeviri katkıları</a> sayfasını ziyaret edin.',
    ...
    FLASHCARD_TAGS_DESC: 'Etiketleri boşluklar veya yeni satırlarla ayırarak girin, örneğin: #flashcards #deck2 #deck3.',
    ...
    INLINE_SCHEDULING_COMMENTS_DESC: 'Bunu açmak, HTML yorumlarının liste biçimlendirmesini bozmamasını sağlar.',
    ...
    CARD_MODAL_SIZE_PERCENT_DESC: 'Mobilde veya çok büyük resimleriniz varsa %100 olarak ayarlayın.',
    ...
    CONVERT_HIGHLIGHTS_TO_CLOZES_DESC: '"Cloze Patterns"den <code>${defaultPattern</code> öğesini ekleyin/kaldırın',
    CONVERT_BOLD_TEXT_TO_CLOZES: '**Kalın metni** gizli kartlara dönüştür?',
    CONVERT_BOLD_TEXT_TO_CLOZES_DESC: '"Cloze Patterns"den <code>${defaultPattern</code> öğesini ekleyin/kaldırın',
    CONVERT_CURLY_BRACKETS_TO_CLOZES: '{{Kıvırcık parantezleri}} gizli kartlara dönüştür?',
    CONVERT_CURLY_BRACKETS_TO_CLOZES_DESC: '"Cloze Patterns"den <code>${defaultPattern</code> öğesini ekleyin/kaldırın',
    ...
    FIX_SEPARATORS_MANUALLY_WARNING: 'Bunu değiştirdikten sonra mevcut flash kartlarınızı manuel olarak düzenlemeniz gerektiğini unutmayın.',
    ...
    INITIALLY_EXPAND_SUBDECKS_IN_TREE_DESC: 'Bunu kapatın, aynı dosyada birçok desteye ait kartlarınız varsa iç içe desteleri daraltmak için kullanışlıdır.',
    ALGORITHM: 'Algoritma',
    CHECK_ALGORITHM_WIKI: 'Daha fazla bilgi için <a href="${algoUrl}">algoritma uygulamasına</a> göz atın.',
