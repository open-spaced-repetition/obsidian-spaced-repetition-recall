...
export default {
    ...
    FLASHCARD_TAGS_DESC: 'Escriba las etiquetas separadas por espacios o saltos de línea, por ejemplo, #memorizar #mazo2 #mazo3',
    ...
    INLINE_SCHEDULING_COMMENTS: '¿Guardar el comentario para programación de las tarjetas en la última línea?',
    INLINE_SCHEDULING_COMMENTS_DESC: 'Activar esto hará que los comentarios HTML no rompan el formato de las listas.',
    BURY_SIBLINGS_TILL_NEXT_DAY: '¿Enterrar tarjetas hermanas hasta el siguiente día?',
    BURY_SIBLINGS_TILL_NEXT_DAY_DESC: 'Los hermanos son tarjetas generadas del mismo texto de la tarjeta, por ejemplo, deletreos de huecos (cloze deletions en inglés)',
    ...
    CONVERT_HIGHLIGHTS_TO_CLOZES_DESC: 'Añadir/eliminar el <code>${defaultPattern}</code> de tus "Patrones de Deletreo de Huecos"',
    CONVERT_BOLD_TEXT_TO_CLOZES: '¿Convertir **texto en negrita** a deletreo de huecos?',
    CONVERT_BOLD_TEXT_TO_CLOZES_DESC: 'Añadir/eliminar el <code>${defaultPattern}</code> de tus "Patrones de Deletreo de Huecos"',
    CONVERT_CURLY_BRACKETS_TO_CLOZES: '¿Convertir {{llaves rizadas}} a deletreo de huecos?',
    CONVERT_CURLY_BRACKETS_TO_CLOZES_DESC: 'Añadir/eliminar el <code>${defaultPattern}</code> de tus "Patrones de Deletreo de Huecos"',
    CLOZE_PATTERNS: 'Patrones de deletreo de huecos',
    CLOZE_PATTERNS_DESC: 'Escriba los patrones de deletreo de huecos separados por saltos de línea. . Check the <a href="${docsUrl}">wiki</a> for guidance.',
    INLINE_CARDS_SEPARATOR: 'Separador de tarjetas de memorización en línea',
    FIX_SEPARATORS_MANUALLY_WARNING: 'Note que después de cambiar este ajuste, tendrá que cambiar manualmente todas las notas que tenga.',
    ...
    ENABLE_FILE_MENU_REVIEW_OPTIONS: 'Habilita las opciones de revisión en el menú Archivo (por ejemplo: Revisar: Fácil, Bien, Difícil)',
    ENABLE_FILE_MENU_REVIEW_OPTIONS_DESC: 'Si desactivas las opciones de revisión en el menú Archivo, puedes revisar tus notas usando los comandos del plugin y, si los definiste, las teclas rápidas asociadas.',
    INITIALLY_EXPAND_SUBDECKS_IN_TREE: 'Los árboles de mazos deberían ser expandidos al inicio.',
    INITIALLY_EXPAND_SUBDECKS_IN_TREE_DESC: 'Desactiva esto para contraer mazos anidados en la misma tarjeta. Útil si tienes tarjetas que pertenecen a muchos mazos en el mismo archivo.',
    ALGORITHM: 'Algoritmo',
    CHECK_ALGORITHM_WIKI: 'Para más información, revisa la <a href="${algoUrl}">implementación del algoritmo</a>.',
    ...
    EASY_BONUS_DESC: 'La bonificación para Fácil te permite establecer la diferencia entre intervalos al responder Bien y Fácil en las tarjetas o notas (mínimo = 100%).',
    ...
    MAX_LINK_CONTRIB_DESC: 'Contribución máxima de la facilidad ponderada de las notas vinculadas a la facilidad inicial.',
    FUZZING: 'Fuzzing',
    ...
    LOGGING: 'Registro',
    DISPLAY_SCHEDULING_DEBUG_INFO: '¿Mostrar información de depuración en la consola de desarrollador',
