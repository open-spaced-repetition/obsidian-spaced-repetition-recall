...
export default {
    ...
    PLEASE_TAG_NOTE:
        "Пожалуйста, добавьте правильный тег к заметке для повторения (проверьте настройки).",
    ...
    CODE_CONTRIBUTION_INFO: 'Информация о <a href="${code_contribution_url}">вкладе в проекта</a>',
...
Обратите внимание, что эта настройка общая для карточек и заметок.`,
    ...
    SHOW_CARD_CONTEXT_DESC:
        "например: Заголовок > Подзаголовок 1 > Подподзаголовок > ... > Подподзаголовок",
    SHOW_INTERVAL_IN_REVIEW_BUTTONS: "Показать время следующего повторения на кнопках повторения",
    SHOW_INTERVAL_IN_REVIEW_BUTTONS_DESC:
        "Полезно знать, насколько далеко в будущее откладываются ваши карточки.",
    ...
    REVIEW_DECK_ORDER_PREV_DECK_COMPLETE_RANDOM: "Случайно (после завершения предыдущей колоды)",
    ...
    CONVERT_HIGHLIGHTS_TO_CLOZES: "Конвертировать ==выделения== в закрытые карточки?",
    CONVERT_BOLD_TEXT_TO_CLOZES: "Конвертировать **жирный текст** в закрытые карточки?",
    CONVERT_CURLY_BRACKETS_TO_CLOZES: "Конвертировать {{фигурные скобки}} в закрытые карточки?",
    CONVERT_HIGHLIGHTS_TO_CLOZES_DESC:
        'Добавить/удалить <code>${defaultPattern}</code> из ваших "Шаблонов закрытых карточек"',
    ...
    CLOZE_PATTERNS_DESC:
        'Введите шаблоны закрытых карточек, разделённые новыми строками. Проверьте <a href="${docsUrl}">wiki</a> для руководства.',
    ...
    OPEN_IN_TAB_DESC: "Отключите это, чтобы открыть плагин в модальном окне",
    SHOW_STATUS_BAR: "Показать строку состояния",
    SHOW_STATUS_BAR_DESC:
        "Отключите это, чтобы скрыть статус повторения карточек в строке состояния Obsidian",
    SHOW_RIBBON_ICON: "Показать иконку на панели ленты",
    SHOW_RIBBON_ICON_DESC: "Отключите это, чтобы скрыть иконку плагина с панели ленты Obsidian",
    ENABLE_FILE_MENU_REVIEW_OPTIONS:
        "Включить опции повторения в меню файла (например: Повторение: Легко, Помню, Сложно)",
    ENABLE_FILE_MENU_REVIEW_OPTIONS_DESC:
        "Если вы отключите опции повторения в меню файла, вы можете повторять заметки используя команды плагина и, если определены, связанные горячие клавиши команд.",
    ...
    SM2_OSR_VARIANT: "Вариант SM-2 от OSR",
    ...
    LOAD_BALANCE_DESC: `Слегка корректирует интервал, чтобы количество повторений в день было более постоянным.
        Это похоже на размытие Anki, но вместо случайности выбирается день с наименьшим количеством повторений.
    ...
    DISPLAY_PARSER_DEBUG_INFO: "Отображать отладочную информацию парсера в консоли разработчика",
    ...
    UNTRACK_WITH_REVIEWTAG_DESC:
        "При удалении тега повторения из заметки синхронно выполнять операцию untrack, чтобы больше не повторять эту заметку<br><b>true</b>: синхронная операция untrack;<br><b>false</b>: после удаления тега повторения нужно снова выполнить untrack, чтобы не повторять эту заметку. (как в предыдущей версии)",
    ...
    FSRS_W_PARAM_DESC:
        'Смотрите <a href="https://github.com/open-spaced-repetition/fsrs4anki/wiki/The-Algorithm">FSRS V6 WIKI</a> и <a href="https://open-spaced-repetition.github.io/anki_fsrs_visualizer">визуализацию параметров FSRS w</a> для настройки различных параметров.',
    ...
    // supermemo.ts
    SM2_ALGORITHM_DESC:
        'Алгоритм, используемый для интервального повторения. В настоящее время использует те же параметры, что и алгоритм Anki (отличается только способ обработки алгоритма). Для получения дополнительной информации см. <a href="https://www.supermemo.com/en/archives1990-2015/english/ol/sm2">алгоритм SM2</a>.',
    ...
    DATA_LOCATION_WARNING_OTHER_ALGO:
        "если вы хотите сохранить данные в файле заметки, вы **должны** использовать алгоритм по умолчанию.",
    ...
    POST_ISSUE_MODIFIED_PLUGIN:
        'Создать <a href="${issue_url}">issue</a> об этом модифицированном sr-плагине с фоновым цветом для настроек.',
