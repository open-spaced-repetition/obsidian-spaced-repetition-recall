...
-   feat: #138 change existing card to other note while retaining review info by @dryezl
-   refactor: dataStore #147

## [1.12.5.24]

-   fix #144 SettingTab display bug
-   fix [#143](https://github.com/open-spaced-repetition/obsidian-spaced-repetition-recall/issues/143) clozeNote null

## [1.12.5.23]

-   feat: Add FSRS Optimizer from review history CSV files #137 by @ishiko732

## [1.12.5.22]

-   close #131 清除已经 untracker 的note
-   fix #139 fix(modal): make .internal-link wikilinks clickable in review modal by @MinhQuangVu0101
-   fix #140 convert default flaschards back to "save on note file"
